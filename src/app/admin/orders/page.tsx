...
export default async function OrdersPage() {
  ...
  if (!session) {
    return <div className="admin-page"><div className="admin-empty-state"><h1 className="admin-empty-title">Please log in</h1><p className="admin-empty-desc">You need to be logged in to manage orders.</p><a href="/" className="btn-primary" style={{ marginTop: 16 }}>Go to Login</a></div></div>;
  }
