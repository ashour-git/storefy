...
export function ThemeCustomizer({ store, initialTheme, initialPage, products }: ThemeCustomizerProps) {
  ...
  const [tokens, setTokens] = useState<Record<string, any>>(() => ({
    ...
    mutedTextColor: s('mutedTextColor', "#64748b"),
    accentColor: s('accentColor', s('secondaryColor', "#334155")),
    fontFamily: s('fontFamily', "Inter"),
    headingFontFamily: s('headingFontFamily', s('fontFamily', "Inter")),
    baseFontSize: s('baseFontSize', "16px"),
    headingFontWeight: s('headingFontWeight', "700"),
    bodyLineHeight: s('bodyLineHeight', "1.6"),
    borderRadius: s('borderRadius', "8px"),
    buttonStyle: s('buttonStyle', "rounded"),
    sectionPadding: s('sectionPadding', "4rem 1rem"),
    pageMaxWidth: s('pageMaxWidth', "1200px"),
    logoUrl: s('logoUrl', ""),
    logoWidth: s('logoWidth', "40px"),
    headerLayout: s('headerLayout', "left"),
    ...
    paymentIcons: (Array.isArray(tk.paymentIcons) ? tk.paymentIcons : []) as string[],
  }));
      ...
      >
        ...
        {isExpanded && (
          <div className="block-item-settings">
            ...
            {/* CATEGORYTILES SETTINGS (moved to BlockEditor) */}

            {/* SPOTLIGHT SETTINGS (moved to BlockEditor) */}

            {/* BENEFITS SETTINGS (moved to BlockEditor) */}

            {/* NESTED SUB-ITEMS LISTS (moved to BlockEditor) */}
            {/* COLLECTION SETTINGS (moved to BlockEditor) */}
